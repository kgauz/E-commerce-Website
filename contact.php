            ...
            <div>
              <ul>
                <?php foreach ($errors as $e): ?>
                  <?php   echo "<script>alert(".json_encode($e).");</script>"; ?>
                <?php endforeach; ?>
              </ul>
            </div>
